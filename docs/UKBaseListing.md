...
**uvc_id** | **string** | UVC ID of the car | [optional] [default to undefined]
...
**co2_emissions** | **string** | CO2 emissions by car | [optional] [default to undefined]
**num_owners** | **string** | Number of owners | [optional] [default to undefined]
**insurance_group** | **string** | Insurance Group of car | [optional] [default to undefined]
...
**car_location** | [**CarLocation**](CarLocation.md) |  | [optional] [default to undefined]
...
```typescript
import { UKBaseListing } from './api';

const instance: UKBaseListing = {
    id,
