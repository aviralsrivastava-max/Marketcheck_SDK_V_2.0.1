...
|------------- | ------------- | -------------|
|[**autoCompleteMotorcycle**](#autocompletemotorcycle) | **GET** /search/motorcycle/auto-complete | API for auto-completion of inputs|
|[**getMotorcycleListing**](#getmotorcyclelisting) | **GET** /listing/motorcycle/{id} | Motorcycle listing by id|
|[**getMotorcycleListingExtra**](#getmotorcyclelistingextra) | **GET** /listing/motorcycle/{id}/extra | Long text Motorcycle Listings attributes for Listing with the given id|
|[**getMotorcycleListingMedia**](#getmotorcyclelistingmedia) | **GET** /listing/motorcycle/{id}/media | Motorcycle listing media by id|
|[**searchMotorcycleActive**](#searchmotorcycleactive) | **GET** /search/motorcycle/active | Gets active motorcycle listings for the given search criteria|

# **autoCompleteMotorcycle**
> SearchAutoCompleteResponse autoCompleteMotorcycle()
...
const apiInstance = new MotorcycleSearchApi(configuration);

let field: 'make' | 'model' | 'trim' | 'body_type' | 'vehicle_type' | 'transmission' | 'drivetrain' | 'fuel_type' | 'color' | 'engine' | 'state' | 'city'; //Field name for which you want auto-completion (default to undefined)
...
const { status, data } = await apiInstance.autoCompleteMotorcycle(
    field,
    input,
    apiKey,
    year,
...
|------------- | ------------- | ------------- | -------------|
| **field** | [**&#39;make&#39; | &#39;model&#39; | &#39;trim&#39; | &#39;body_type&#39; | &#39;vehicle_type&#39; | &#39;transmission&#39; | &#39;drivetrain&#39; | &#39;fuel_type&#39; | &#39;color&#39; | &#39;engine&#39; | &#39;state&#39; | &#39;city&#39;**]**Array<&#39;make&#39; &#124; &#39;model&#39; &#124; &#39;trim&#39; &#124; &#39;body_type&#39; &#124; &#39;vehicle_type&#39; &#124; &#39;transmission&#39; &#124; &#39;drivetrain&#39; &#124; &#39;fuel_type&#39; &#124; &#39;color&#39; &#124; &#39;engine&#39; &#124; &#39;state&#39; &#124; &#39;city&#39;>** | Field name for which you want auto-completion | defaults to undefined|
...
# **getMotorcycleListing**
> MotorcycleListing getMotorcycleListing()
...
const { status, data } = await apiInstance.getMotorcycleListing(
    id,
    apiKey
);
```
...
# **getMotorcycleListingExtra**
> ListingExtraAttributes getMotorcycleListingExtra()
...
const { status, data } = await apiInstance.getMotorcycleListingExtra(
    id,
    apiKey
);
```
...
# **getMotorcycleListingMedia**
> ListingMedia getMotorcycleListingMedia()
...
const { status, data } = await apiInstance.getMotorcycleListingMedia(
    id,
    apiKey
);
```
...
# **searchMotorcycleActive**
> MotorcycleSearchResponse searchMotorcycleActive()
...
let taxonomyVin: string; //Taxonomy VIN of the motorcycle (optional) (default to undefined)
let inventoryType: 'used' | 'new'; //To filter listing on their condition. Either used or new (optional) (default to undefined)
...
const { status, data } = await apiInstance.searchMotorcycleActive(
    apiKey,
    priceRange,
    milesRange,
    msrpRange,
...
| **taxonomyVin** | [**string**] | Taxonomy VIN of the motorcycle | (optional) defaults to undefined|
| **inventoryType** | [**&#39;used&#39; | &#39;new&#39;**]**Array<&#39;used&#39; &#124; &#39;new&#39;>** | To filter listing on their condition. Either used or new | (optional) defaults to undefined|
