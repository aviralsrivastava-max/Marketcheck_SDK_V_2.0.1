...
**dist** | **number** | Distance of the motorcycle\&#39;s location from the specified user lcoation | [optional] [default to undefined]

## Example

```typescript
import { MotorcycleBaseListing } from './api';

const instance: MotorcycleBaseListing = {
    id,
    vin,
    heading,
    price,
